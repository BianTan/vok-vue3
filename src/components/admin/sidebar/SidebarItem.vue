<template>
  <li
    class="relative h-14 items-center transition ease-in-out duration-300 hover:bg-admin-blue-50 hover:text-admin-blue-500"
    :class="itemClass"
  >
    <router-link
      :to="url"
      class="flex text-xl pl-14 lg:pl-4 xl:pl-14 items-center h-full"
    >
      <slot />
    </router-link>
  </li>
